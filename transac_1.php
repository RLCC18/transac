                ...
                <div class="card">
                    <div class="transact">
                        ...
                        <form class="form" method="post">
                            <div class="form-row">
                                <input class="form-control mt-5 mr-5 ml-5" type="text" placeholder="Enter your name..." name="userbox1">
                            </div>
                            <button class="btn btn-submit" type="submit" name="withbtn">Submit</button>
                        </form>
                    </div>
                </div>
            </div>
